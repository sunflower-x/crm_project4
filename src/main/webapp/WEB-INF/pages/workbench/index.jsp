...
<head>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            window.open("workbench/main/index.do", "work   b areaFrame");
            //给退出确定按钮添加单击事件
        ...
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button id="logoutBtn" type="button"
                        class="btn btn-primary" <%--onclick="window.location.href='settings/qx/user/logout.do';"--%>
...
<div id="top" style="height: 50px; background-color: #3C3C3C; width: 100%;">
    <div style="position: absolute; top: 5px; left: 0px; font-size: 30px; font-weight: 300; color: white; font-family: 'times new roman'">
        CRM &nbsp;<span style="font-size: 12px;">&copy;2022&nbsp;动力节点</span></div>
    <div style="position: absolute; top: 15px; right: 15px;">
        <ul>
            <li class="dropdown user-dropdown">
                <a href="javascript:void(0)" style="text-decoration: none; color: white; margin-left: 40px"
...
<div id="center" style="position: absolute;top: 50px; bottom: 30px; left: 0px; right: 0px;">
    ...
    <div id="navigation" style="left: 0px; width: 18%; position: relative; height: 100%; overflow:auto;">
        ...
        <ul id="no1" class="nav nav-pills nav-stacked">
            ...
            <li class="liClass"><a href="workbench/activity/toActivity.do" target="workareaFrame"><span
